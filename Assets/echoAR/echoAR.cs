...
public class echoAR : MonoBehaviour
{
    ...
    // Your echoAR API key
    //protected string APIKey = "orange-mud-2447";
    protected string APIKey = "quiet-bar-6545";
    ...
    protected IEnumerator QueryDatabase(string serverURL)
    {
    ...
    protected IEnumerator DownloadAssets(string serverURL)
    {
    ...
    public virtual void DownloadEntryAssets(Entry entry, string serverURL)
    {


        // Check if Unity is supported
        //if (entry.getSupportedSDKs()[Entry.SDKs.UNITY.ordinal()])  
        entry.getAdditionalData().TryGetValue("name", out string myType);
        if (myType == "tileGrass" || myType == "tileRoad")
        {
            // Get hologram type
    ...
    protected ImportOptions ParseAdditionalData(Dictionary<string, string> additionalData)
    {
    ...
    protected IEnumerator DownloadandInitiateImage(Entry entry, string imageURL, GameObject imagePlane)
    {
        // Get texture
    ...
    protected IEnumerator DownloadFiles(Entry entry, string serverURL, List<string> filenames, List<string> fileStorageIDs, ImportOptions importOptions)
    {
    ...
    protected IEnumerator InstantiateModel(Entry entry, List<string> filenames, ImportOptions importOptions)
    {
    ...
    protected IEnumerator WebsocketClient()
    {
